...
namespace CombatSystem.Attributes
{
    ...
    public class Attribute
    {
        ...
        private Attribute _maxValueAttribute;
        ...
        public float BaseValue
        {
            ...
            set
            {
                ...
                {
                    baseValue = Mathf.Min(value, _maxValueAttribute.CurrentValue);
                }
                else
                {
                    baseValue = value;
        ...
        {
            _maxValueAttribute = modifiableAttributeValue;
        }
        ...
        public void UpdateCurrentValue()
        {
            ...
            if (_maxValueAttribute != null)
            {
                CurrentValue = Math.Max(_maxValueAttribute.CurrentValue, CurrentValue);
            }
