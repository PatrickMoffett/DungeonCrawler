...
{
    public class OutgoingStatusEffect
    {
        public CombatSystemComponent SourceCombatSystemComponent { get; }
        public StatusEffect StatusEffect { get; }

        public OutgoingStatusEffect(CombatSystemComponent sourceCombatSystemComponent, StatusEffect statusEffect)
        {
            SourceCombatSystemComponent = sourceCombatSystemComponent;
    ...
    {
        public CombatSystemComponent SourceCombatSystemComponent { get; }
        public CombatSystemComponent TargetCombatSystemComponent { get; }
        public StatusEffect StatusEffect { get; }
        
        public AppliedStatusEffect(CombatSystemComponent targetCombatSystemComponent, OutgoingStatusEffect statusEffect)
        {
            SourceCombatSystemComponent = statusEffect.SourceCombatSystemComponent;
            TargetCombatSystemComponent = targetCombatSystemComponent;
            StatusEffect = Object.Instantiate(statusEffect.StatusEffect);
        }

        public AppliedStatusEffect(CombatSystemComponent sourceCombatSystemComponent,
            CombatSystemComponent targetCombatSystemComponent, StatusEffect statusEffect)
        {
            SourceCombatSystemComponent = sourceCombatSystemComponent;
            TargetCombatSystemComponent = targetCombatSystemComponent;
            StatusEffect = Object.Instantiate(statusEffect);
        }
    }
    ...
    public class StatusEffect : ScriptableObject
    {
        ...
        public AttributeModifierValue periodicRate;
        /// <summary>
